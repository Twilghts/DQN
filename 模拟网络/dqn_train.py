...
if __name__ == '__main__':
    ...
    print(
        f'这次数据包的大小:{dqn_net_agent.data_size},数据包个数{dqn_net_agent.data_number}。使用DQN算法的丢包率的集合:{average_loss}')
    ...
    print(
        f'这次数据包的大小:{dqn_net_agent.data_size},DQN算法一次数据传输过程中消耗的平均总时间为:{np.mean(average_time)}')
